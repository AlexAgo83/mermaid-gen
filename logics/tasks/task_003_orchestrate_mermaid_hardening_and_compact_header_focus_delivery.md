...
- finish with browser validation on desktop and mobile flows, especially generation failure handling, header actions, burger menu behavior, and focus-preview mode
...
- [ ] 6. Wave 5: make preview focus feel full page and remove panel chrome from `item_016`, then update linked docs and checkpoint the wave.
...
- AC5 -> `item_016_make_preview_focus_feel_full_page_and_remove_panel_chrome`: focus mode feels like a full-page takeover rather than a decorated panel. Proof: desktop and mobile browser validation in focus mode.
...
# AI Context
- Summary: Orchestrate the next Mermaid Generator delivery package across generated Mermaid hardening, compact header controls, mobile burger navigation, and immersive focus-preview behavior.
