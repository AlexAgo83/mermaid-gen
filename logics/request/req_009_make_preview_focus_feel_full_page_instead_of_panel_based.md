...
- the only persistent shell element in focus mode should be the main application header
...
- preview-local header and toolbar chrome should disappear in focus mode instead of competing with the global header
